  ...
  return (
    <div className="p-6">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold text-gray-900">Delivery Executive Details</h1>
        <p className="text-lg text-gray-600">{referralData?.partnerName || 'Executive Name'}</p>
      </div>
      ...
      {loading ? (
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {/* Referred New Executive */}
            <div className="bg-white rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-4">Referred New Executive</h3>
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-medium text-gray-900">Rajesh Kumar</p>
                  <p className="text-xs text-gray-500">Executive ID: DP2023045</p>
                </div>
            ...
            {/* Referring Executive */}
            <div className="bg-white rounded-lg p-6">
              <h3 className="text-lg font-semibold mb-4">Referring Executive</h3>
              <div className="space-y-3">
                <div>
                  <p className="text-sm font-medium text-gray-900">Amit Singh</p>
                  <p className="text-xs text-gray-500">Executive ID: DP2023012</p>
                </div>
                <div className="flex items-center gap-2 text-sm text-gray-600">
                  <Phone size={16} />
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <p>Referred Executive Bonus Amount: ₹200</p>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button className="px-4 py-2 bg-red-500 text-white rounded hover:bg-red-600">
                Pay Bonus to Referred Executive
              </button>
          ...
          <div className="bg-white rounded-lg p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                <span className="text-gray-900">New Executive Registered</span>
                <span className="text-gray-500">15 Jun 2023, 14:45</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-900">New Executive Completed Onboarding</span>
                <span className="text-gray-500">16 Jun 2023, 10:15</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-900">New Executive First Delivery</span>
          ...
          <div className="flex justify-center gap-4">
            <button className="flex items-center gap-2 px-6 py-3 bg-red-500 text-white rounded hover:bg-red-600">
              <Phone size={18} />
              Contact Referred Executive
            </button>
            <button className="flex items-center gap-2 px-6 py-3 bg-red-500 text-white rounded hover:bg-red-600">
              <Phone size={18} />
              Contact Referrer Executive
            </button>
          </div>
        </div>
      )}
