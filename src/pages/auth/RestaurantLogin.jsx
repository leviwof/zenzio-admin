...
const RestaurantLogin = () => {
  ...
  const isRestaurant = loginType === 'restaurant';
  const logo = isRestaurant ? restaurantLogo : adminLogo;
      ...
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-3 text-white rounded transition disabled:opacity-50 ${isRestaurant ? 'bg-green-600 hover:bg-green-700' : 'bg-red-500 hover:bg-red-600'}`}
          >
